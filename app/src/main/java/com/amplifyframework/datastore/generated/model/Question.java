...
public final class Question implements Model {
  ...
  public Question(String id, CategoryEnum category, Boolean type, DifficultyEnum difficulty, String question, String correct_answer, List<String> incorrect_answers) {
    this.id = id;
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, CategoryEnum category, Boolean type, DifficultyEnum difficulty, String question, String correctAnswer, List<String> incorrectAnswers) {
      super.id(id);
